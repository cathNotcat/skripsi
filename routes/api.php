...
use App\Http\Controllers\get_all_dbpengiriman_tanggal_by_sopir;
...
Route::get('/pengiriman/all/tanggal/{sopir}', [get_all_dbpengiriman_tanggal_by_sopir::class, 'getData']);
